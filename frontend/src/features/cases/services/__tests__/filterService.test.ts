...
describe('FilterService', () => {
    ...
    describe('createFilter', () => {
        ...
        it('creates a filter and returns it', async () => {
            const created = { filter_Id: 1, user_id: 'u1', created_at: '', user_filters: '{}', filter_type: 'CASE', updated_at: '' };
        ...
        it('throws with API response message', async () => {
            ...
            await expect(service.createFilter(dto)).rejects.toThrow('Validation failed');
        });
    });
});
