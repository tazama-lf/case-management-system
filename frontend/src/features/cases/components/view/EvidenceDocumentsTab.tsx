...
const EvidenceDocumentsTab: React.FC<EvidenceDocumentsTabProps> = ({
  ...
  const handleVerify = async (evidenceItem: Evidence) => {
    verifyMutation.mutate({
      ...
      expectedHash: evidenceItem.hash,
    });
  };
      ...
      <div className="flex items-center justify-between gap-4">
        <div className="flex-1 flex items-center gap-2">
          ...
          <button
            ...
            className={`inline-flex items-center gap-2 rounded-md border px-3 py-2 text-sm font-medium shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 ${showFilters
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-4 mt-3 text-sm text-gray-500">
                      <span className="flex items-center gap-1">
                        ...
                        {item.uploadedBy || item.uploader_id}
                      </span>
                      <span className="flex items-center gap-1">
                      ...
                      <span>
                        {evidenceService.formatFileSize(item.fileSize)}
                      </span>
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <p className="text-gray-900">{evidence.fileName}</p>
              </div>
              <div>
                <p className="text-sm font-medium text-gray-500">
                  Evidence Type
                </p>
                <p className="text-gray-900">{evidence.evidenceType}</p>
              </div>
              <div>
              ...
              <div>
                ...
                <p className="text-gray-900">
                  {evidence.uploadedBy || evidence.uploader_id}
                </p>
              </div>
              <div>
