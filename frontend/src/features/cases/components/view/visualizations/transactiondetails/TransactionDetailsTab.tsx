    ...
    return (
      <div className="rounded-lg border border-yellow-200 bg-yellow-50 p-4">
        ...
        <p className="text-xs text-yellow-600 mt-3 italic">
          The backend transaction details service may not have seeded data for
          this transaction.
        </p>
      </div>
    );
            ...
            <div className="flex items-center gap-3 mb-3">
              ...
              <div>
                ...
                <div className="text-sm font-semibold text-gray-900">
                  {data.transactionFlow.debtor.name}
                </div>
              </div>
            </div>
            <div className="space-y-1.5 text-xs">
              <div>
                ...
                <span className="ml-2 text-gray-900 font-medium">
                  {data.transactionFlow.debtor.account.iban
                    ? `${data.transactionFlow.debtor.account.iban.slice(0, 4)}••••${data.transactionFlow.debtor.account.iban.slice(-15)}`
                    : ''}
                </span>
              </div>
              <div>
                ...
                <span className="ml-2 text-gray-900">
                  {data.transactionFlow.debtor.bank}
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="flex-1 bg-white rounded-lg border border-gray-200 p-4">
            <div className="flex items-center gap-3 mb-3">
              ...
              <div>
                ...
                <div className="text-sm font-semibold text-gray-900">
                  {data.transactionFlow.creditor.name}
                </div>
              </div>
            </div>
            <div className="space-y-1.5 text-xs">
              <div>
                <span className="text-gray-500">Account:</span>
                <span className="ml-2 text-gray-900 font-medium">
                  {data.transactionFlow.creditor.account.iban
                    ? `${data.transactionFlow.creditor.account.iban.slice(0, 4)}••••${data.transactionFlow.creditor.account.iban.slice(-15)}`
                    : ''}
                </span>
              </div>
              <div>
                <span className="text-gray-500">Bank:</span>
                <span className="ml-2 text-gray-900">
                  {data.transactionFlow.creditor.bankName}
                </span>
              </div>
            </div>
          </div>
