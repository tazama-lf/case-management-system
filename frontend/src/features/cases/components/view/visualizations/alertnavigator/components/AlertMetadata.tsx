    ...
    <div className="rounded-lg border border-gray-200 bg-white p-5">
      ...
      <div className="grid grid-cols-2 gap-x-8 gap-y-4">
        ...
        <div>
          ...
          <div className="text-sm font-medium text-gray-900">{transactionType}</div>
        </div>
        <div>
          <div className="text-xs font-medium text-gray-500 uppercase mb-1">Entity</div>
        ...
        {blockReason && (
          <div className="col-span-2">
            <div className="text-xs font-medium text-gray-500 uppercase mb-1">Block Reason</div>
