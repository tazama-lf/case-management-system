...
const AbandonCaseModal: React.FC<AbandonCaseModalProps> = ({
  ...
  const isConfirmValid = confirmText.toLowerCase() === 'abandon';
  const isReasonValid = reason.trim().length >= 10;

  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    if (!caseData || !isConfirmValid || !isReasonValid) return;
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-6">
              <label htmlFor="confirm" className="block text-sm font-medium text-gray-700 mb-2">
                Type "abandon" to confirm <span className="text-red-500">*</span>
              </label>
              <input
                id="confirm"
                type="text"
            ...
            <div className="flex gap-3 justify-end">
              ...
              <button
                type="submit"
                disabled={isSubmitting || !isConfirmValid || !isReasonValid}
