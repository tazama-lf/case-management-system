...
export type { MockAlertData } from './mockAlertData';
export type { MockTransactionMessage } from './mockTransactionMessages';
export type { LinkItemData } from './mockLinkedItemsData';