...
interface SupervisorCasesTableSkeletonProps {
  rows?: number;
}

const SupervisorCasesTableSkeleton: React.FC<SupervisorCasesTableSkeletonProps> = ({ rows = 5 }) => {
  return (
...
export default SupervisorCasesTableSkeleton;
