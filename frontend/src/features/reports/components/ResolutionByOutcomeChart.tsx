...
import type { ResolutionByOutcome } from '../types/reports.types';

interface ResolutionByOutcomeChartProps {
...
const ResolutionByOutcomeChart: React.FC<ResolutionByOutcomeChartProps> = ({
  data,
  title,
  height = 220,
}) => {
...
export default ResolutionByOutcomeChart;
