                ...
                <div className="flex flex-col lg:flex-row lg:items-center lg:gap-6 gap-4">
                    <div className="lg:max-w-md">
                        ...
                        <p className="text-gray-600 mt-1">
                            Enter the Transaction Type and System Reference ID to add a new reference record.
                        </p>
                    </div>
      ...
      `}
            ...
            {loading ? (
                <div className="flex flex-col justify-center items-center py-20">
                    ...
                    <p className="mt-6 text-gray-600 font-medium">Loading reference records...</p>
                </div>
            ) : results.length > 0 ? (
                ...
                <div className="py-16 text-center text-gray-400">No reference records found.</div>
            )}
        </PageContainer>
    );
};
