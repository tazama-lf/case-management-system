...
import { ExclamationCircleIcon, DocumentIcon, FolderIcon } from '@heroicons/react/24/outline';
...
const EmptyState: React.FC<EmptyStateProps> = ({ 
  ...
  const getActionClasses = () => {
    const baseClasses = "inline-flex items-center px-4 py-2 border rounded-md shadow-sm text-sm font-medium";
