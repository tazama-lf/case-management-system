...
const permissionMatrix = permissionMatrixImport as any;

export type Matrix = typeof permissionMatrix;
export type EndpointKey = keyof Matrix['endpoints'] & string;
export type Role = keyof Matrix['_meta']['roles'] & string;
