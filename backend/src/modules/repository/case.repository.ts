...
export class CaseRepository {
    ...
    async findCaseByAlertId(alertId: string) {
    ...
    async findCasesWithFilters(whereClause: Prisma.CaseWhereInput, options: { skip: number; limit: number; sortBy: string; sortOrder: 'asc' | 'desc' }) {
    ...
    async findCasesWithOrConditions(whereConditions: Prisma.CaseWhereInput[], options: { skip: number; limit: number; sortBy: string; sortOrder: 'asc' | 'desc' }) {
        return await this.prismaService.case.findMany({
