...
import { NotificationChannel, NotificationType, UserNotificationPreference } from '@prisma/client-cms';
...
export class NotificationPreferencesService {
  ...
  private async createDefaultPreferences(userId: string, tenantId: string): Promise<UserNotificationPreference> {
    return await this.prisma.userNotificationPreference.create({
      data: {
        user_id: userId,
        tenant_id: tenantId,
        email_enabled: true,
