...
-- CreateEnum
CREATE TYPE "public"."AlertStatus" AS ENUM ('NEW', 'AUTOCLOSED_CONFIRMED', 'AUTOCLOSED_REFUTED', 'CLOSED', 'CONVERTED', 'SENT_FOR_INVESTIGATION');

-- CreateEnum
CREATE TYPE "public"."CaseType" AS ENUM ('FRAUD', 'AML', 'FRAUD_AND_AML');
...
CREATE TABLE "public"."alerts" (
    ...
    "prediction_outcome" "public"."PredictionOutcome" DEFAULT 'FALSE_POSITIVE',
    "source" VARCHAR(50),
    "txtp" VARCHAR(50),
