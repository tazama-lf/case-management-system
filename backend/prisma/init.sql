...
-- Grant permissions
GRANT USAGE ON SCHEMA public TO tazama_user;
GRANT CREATE ON SCHEMA public TO tazama_user;
GRANT SELECT, INSERT, UPDATE, DELETE ON ALL TABLES IN SCHEMA public TO tazama_user;
GRANT USAGE, SELECT ON ALL SEQUENCES IN SCHEMA public TO tazama_user;

-- Set default permissions for future tables
ALTER DEFAULT PRIVILEGES IN SCHEMA public GRANT SELECT, INSERT, UPDATE, DELETE ON TABLES TO tazama_user;
ALTER DEFAULT PRIVILEGES IN SCHEMA public GRANT USAGE, SELECT ON SEQUENCES TO tazama_user;
