...
describe('FlowableService', () => {
  ...
  describe('deployProcess', () => {
    it('should successfully deploy a BPMN process', async () => {
      ...
      expect(loggerService.log).toHaveBeenCalledWith(`Process deployed successfully: ${mockResponse.data.id}`, FlowableService.name);
    });
    ...
    it('should handle deployment errors', async () => {
      ...
      expect(loggerService.error).toHaveBeenCalledWith(`Failed to deploy process: ${error.message}`, error.stack, FlowableService.name);
    });
  });
  ...
  describe('startProcessInstance', () => {
    it('should start a process instance successfully', async () => {
      ...
      expect(result).toEqual(mockResponse.data);
      expect(mockAxiosInstance.post).toHaveBeenCalledWith('/service/runtime/process-instances', {
      ...
      expect(loggerService.log).toHaveBeenCalledWith(`Process instance started: ${mockResponse.data.id}`, FlowableService.name);
    });
  ...
  describe('getProcessInstance', () => {
    it('should retrieve a process instance successfully', async () => {
      ...
      expect(result).toEqual(mockResponse.data);
      expect(mockAxiosInstance.get).toHaveBeenCalledWith(`/service/runtime/process-instances/${processInstanceId}`);
    });
  ...
  describe('getProcessTasks', () => {
    ...
    it('should handle errors when retrieving tasks', async () => {
      ...
      expect(loggerService.error).toHaveBeenCalledWith(`Failed to get process tasks: ${error.message}`, error.stack, FlowableService.name);
    });
  });
  ...
  describe('completeTask', () => {
    it('should complete a task successfully without variables', async () => {
      ...
      expect(result).toEqual(mockResponse.data);
      expect(mockAxiosInstance.post).toHaveBeenCalledWith(`/service/runtime/tasks/${taskId}`, {
        action: 'complete',
        variables: [],
      });
    ...
    it('should handle errors when completing task', async () => {
      ...
      expect(loggerService.error).toHaveBeenCalledWith(`Failed to complete task: ${error.message}`, error.stack, FlowableService.name);
    });
  });
  ...
  describe('claimTask', () => {
    it('should claim a task successfully', async () => {
      ...
      expect(loggerService.log).toHaveBeenCalledWith(`Task ${taskId} claimed by user ${userId}`, FlowableService.name);
    });
    ...
    it('should handle errors when claiming task', async () => {
      ...
      expect(loggerService.error).toHaveBeenCalledWith(`Failed to claim task: ${error.message}`, error.stack, FlowableService.name);
    });
  });
